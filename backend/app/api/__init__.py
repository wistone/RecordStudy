...
from .record_templates import router as record_templates_router
...
api_router.include_router(record_templates_router, prefix="/record-templates", tags=["record-templates"])
